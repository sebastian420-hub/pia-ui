...
export const TIER_RULES: Record<WebTier, { minEvents: number; labels: number; orgActivity: number }> = {
  0: { minEvents: 20, labels: 18, orgActivity: 20 },
  1: { minEvents: 5, labels: 100, orgActivity: 5 },
  2: { minEvents: 1, labels: 400, orgActivity: 1 },
};
