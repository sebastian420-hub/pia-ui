...
export const VerdictBadge: React.FC<{ verdict?: string | null }> = ({ verdict }) => {
  ...
  if (verdict === 'recorded') return <span className="ml-1 text-[9px] px-1 rounded bg-accent/20 text-accent align-middle" title="a structured record from a database or a human report — its trust is the source's">recorded</span>;
